...
<head>
    <link rel="stylesheet" type="text/css" href="../css/footerTienda.css" />
    ...
    <footer class="all-footer">
        <div class="footer-container">
            ...
            <div class="header-footer">
                <img src="../img/Logo PNG/logo_name_lila.svg" alt="Imagotipo" class="imagotipo" width="200px">
                <div class="rrss">
                    <a href="https://es.linkedin.com/in/betsabethtorres" target="_blank"><img src="../img/Redes sociales/lila/Iconos_Mesa de trabajo 1 copia 20.svg" alt="lnkdin" class="icono"></a>
                    <a href="https://discord.gg/bUaJPQgn" target="_blank"><img src="../img/Redes sociales/lila/Iconos_Mesa de trabajo 1 copia 19.svg" alt="telegram" class="icono"></a>
                    <a href="https://www.instagram.com/kyaalena_/" target="_blank"><img src="../img/Redes sociales/lila/Iconos_Mesa de trabajo 1 copia 18.svg" alt="instagram" class="icono"></a>
                    <a href="https://twitter.com/kyaalena?lang=es" target="_blank"><img src="../img/Redes sociales/lila/icon-redes-sociales-twitter.svg" alt="twitter" class="icono"></a>
                    <a href="https://www.tiktok.com/@kyaalena" target="_blank"><img src="../img/Redes sociales/lila/Iconos_Mesa de trabajo 1 copia 23.svg" alt="tiktok" class="icono"></a>
                </div>
            </div>
