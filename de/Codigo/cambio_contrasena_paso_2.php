...
<body>
    ...
    <h2 class="h2">LETZTER SCHRITT ZUR PASSWORTÄNDERUNG</h2>
    ...
    <div id="DivForm" class="DivForm">
        ...
        <form action="#" method="post" class="formulario">
            <table>
                <tr>
                    <td class="ojos"><input type="password" class="Inputs" name="nuevacontrasena" id="nuevacontrasena" placeholder="Neues Kennwort*"></td>
                    <td>
                ...
                <tr>
                    <td><input type="password" class="Inputs" name="nuevacontrasena_confirm" id="nuevacontrasena_confirm" placeholder="Kennwort bestätigen*"></td>
                    <td></td>
                </tr>
                <tr>
                    <td><input type="email" class="Inputs" name="correo" id="correo" placeholder="Email*"><br>
                        <input class="enviar" type="submit" name="cambio" id="cambio" value="Ändern Sie">
                    </td>
