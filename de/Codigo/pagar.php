...
<div class="jumbotron text-center" style="margin-bottom: 0px;">
    <h1 class="display-4">¡Letzter Schritt!</h1>
    <hr class="my-4">
    <p class="lead">Sie sind im Begriff, den Betrag von:
    <h4><?php echo $total ?> €</h4>
    <div id="paypal-button-container"></div>
    </p>
    <p class="descargados">
    Die Produkte stehen zum Download zur Verfügung, sobald die Zahlung erfolgt ist.
    </p>
