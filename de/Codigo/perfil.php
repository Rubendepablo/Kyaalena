    ...
    if (isset($_SESSION['usuario'])) {
      ...
      while ($fila = $MyBBDD->extraer_registro()) {
        ...
        echo '<form action="#" method="post">
                <table>
                  <tr> 
                    <td colspan="4"><h1 class="tucuenta">Ihr Konto</h1></td>
                  </tr>
                  <tr> 
                  <td colspan="2"><label> E-Mail  </label><br><input type="text" id="emailPerfil" name="emailPerfil" value="' . $fila['correo'] . '" disabled><button type="submit" id="btn_edit_email"><img src="../img/Perfil/store_perfil_de_usuario_editar.svg" width="15px" alt="modificiar"></button><br>
                  <td colspan="2"><label> Kennwort  </label><br><input type="password" id="contrasenaPerfil" name="contrasenaPerfil" value="' . $fila['contrasena'] . ' " disabled><button type="submit" id="btn_edit_contra"><img src="../img/Perfil/store_perfil_de_usuario_editar.svg" width="15px" alt="modificiar"></button><br>
                  </tr>
                  <tr> 
                  <td colspan="2"><h1>Persönliche Informationen</h1>
                  <td colspan="2"><h1>Rechnungsadresse</h1>
                  </tr>           
                  <tr>
                  <td colspan="2"><label> Name  </label><br><input type="text" id="nombrePerfil" name="nombrePerfil" value="' . $fila['nombre'] . ' " > <br>
                  <td colspan="2"><input type="text" id="direccionPerfil" name="direccionPerfil" placeholder="Adresse" value="' . $fila['direccion'] . ' " > <br>
                  </tr>
                  <tr>
                  <td colspan="2"><label> Nachname  </label><br><input type="text" id="apellidosPerfil" name="apellidosPerfil" value="' . $fila['apellidos'] . ' " > <br>
                  <td colspan="1"><input type="text" id="numeroCallePerfil" name="numeroCallePerfil" placeholder="Hausnummer" value="' . $fila['numero_calle'] . ' " > <br>
                  <td colspan="1"><label id="margen"> Boden, Tür, etc. </label><br><input type="text" id="pisoPerfil" name="pisoPerfil" value="' . $fila['piso'] . ' " > <br>
                  </tr>
                  <tr>
                  <td><label> Vorsilbe </label> <br><select name="prefijoPerfil" id="prefijoPerfil">
                            ...
                            <td><label id="margen"> Rufnummer </label><br><input type="number" id="telefonoPerfil" name="telefonoPerfil" value="' . $fila['telefono'] . '" > <br>
                            <td><label> Postleitzahl </label><br><input type="text" id="codigoPostalPerfil" name="codigoPostalPerfil" value="' . $fila['codigo_postal'] . ' " > <br>
                            <td><label id="margen"> Provinz </label><br> <select name="provinciaPerfil" id="provinciaPerfil">
                  ...
                  <tr>
                    <td colspan="2">
                      <input type="submit" id="guardar" name="guardar" value="Speichern" style="display: none;">
                      <input type="submit" id="guardar1" name="guardar1" value="Speichern" style="display: none;">
                      <input type="submit" id="guardar2" name="guardar2" value="Speichern" style="display: none;">
                      <input type="submit" id="guardar3" name="guardar3" value="Speichern" style="display: none;">
                    </td>
                  </tr>
                </table>
              </form>';
        ...
        try {
          ...
          echo '<script>
                  Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: "Profil wurde erfolgreich geändert.",
      ...
      if (isset($_POST['guardar2'])) {
        ...
        try {
          ...
          echo "<script>alert(Fehler beim Aktualisieren des Profils: );</script>'" . $e->getMessage();
        }
      }
