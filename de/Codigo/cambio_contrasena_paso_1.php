...
<body>
	...
	<h2 class="h2">ÄNDERUNG DES PASSWORTS</h2>
	<div class="DivForm">
		<h3>
		...
		<form method="post" action="#" class="formulario">
			...
			<input class="Inputs" type="email" name="correo" id="correo" placeholder="Geben Sie Ihre E-Mail Adresse ein*"><br>
			<button class="continuar" type="submit" name="continuar" id="continuar">Weiter</button>
		</form>
	</div>
	...
	if (isset($_POST['continuar'])) {
		...
		if ($MyBBDD->numero_filas() == 1) {
			...
			Swal.fire({
				position: "top-end",
				icon: "success",
				title: "Kommen wir nun zum letzten Schritt!.",
			...
			Swal.fire({
				icon: "error",
				title: "Oops...",
				text: "Die E-Mail existiert nicht, bitte versuchen Sie es erneut.",
				customClass: {
