        ...
        <table class="table table-light table-bordered">
            <tbody>
                <tr>
                    ...
                    <th width="20%" class="text-center">Talla</th>
                    ...
                    <tr>
                        ...
                        <td width="10%">
                            <form action="" method="post">
                                ...
                                <button class="btn-danger" type="submit" name="btnAccion" value="Eliminar">Eliminar</button>
                            </form>
                        </td>
                    </tr>
                <?php
                        ...
                        <form action="pagar.php" method="post">
                            <div class="alert">
                                <div class="form-group">
                                    <label for="my-input">Dirección de domicilio: </label>
                                    <input id="direccion" name="direccion" class="form-control" type="text" placeholder="Por favor escribe tú dirección" required>
                                </div>
                                <div class="nada">
                            ...
                            <button class="btn-pay" type="submit" name="btnAccion" value="proceder">
                                Proceder a pagar >>
                            </button>
