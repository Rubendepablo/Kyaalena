...
<body>
    ...
    <h2 class="h2">ULTIMO PASO PARA EL CAMBIO DE CONTRASEÑA</h2>
    ...
    <div id="DivForm" class="DivForm">
        ...
        <form action="#" method="post" class="formulario">
            <table>
                <tr>
                    <td class="ojos"><input type="password" class="Inputs" name="nuevacontrasena" id="nuevacontrasena" placeholder="Nueva contraseña*"></td>
                    <td>
                ...
                <tr>
                    <td><input type="password" class="Inputs" name="nuevacontrasena_confirm" id="nuevacontrasena_confirm" placeholder="Confirma la contraseña*"></td>
                    <td></td>
                </tr>
                <tr>
                    <td><input type="email" class="Inputs" name="correo" id="correo" placeholder="Email*"><br>
                        <input class="enviar" type="submit" name="cambio" id="cambio" value="Cambio">
                    </td>
    ...
    if (isset($_POST['cambio'])) {
        ...
        if ($nueva == $confirmar) {
			...
			Swal.fire({
				position: "top-end",
				icon: "success",
				title: "Se ha modificado la contraseña correctamente.",
