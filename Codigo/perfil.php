    ...
    if (isset($_SESSION['usuario'])) {
      ...
      while ($fila = $MyBBDD->extraer_registro()) {
        ...
        echo '<form action="#" method="post">
                <table>
                  <tr> 
                    <td colspan="4"><h1 class="tucuenta">Tu cuenta</h1></td>
                  </tr>
                  <tr> 
                  <td colspan="2"><label> Email  </label><br><input type="text" id="emailPerfil" name="emailPerfil" value="' . $fila['correo'] . '" disabled><button type="submit" id="btn_edit_email"><img src="../img/Perfil/store_perfil_de_usuario_editar.svg" width="15px" alt="modificiar"></button><br>
                  <td colspan="2"><label> Contraseña  </label><br><input type="password" id="contrasenaPerfil" name="contrasenaPerfil" value="' . $fila['contrasena'] . ' " disabled><button type="submit" id="btn_edit_contra"><img src="../img/Perfil/store_perfil_de_usuario_editar.svg" width="15px" alt="modificiar"></button><br>
                  </tr>
                  <tr> 
                  <td colspan="2"><h1>Información Personal</h1>
                  <td colspan="2"><h1>Dirección de facturación</h1>
                  </tr>           
                  <tr>
                  <td colspan="2"><label> Nombre  </label><br><input type="text" id="nombrePerfil" name="nombrePerfil" value="' . $fila['nombre'] . ' " > <br>
                  <td colspan="2"><input type="text" id="direccionPerfil" name="direccionPerfil" placeholder="Dirección" value="' . $fila['direccion'] . ' " > <br>
                  </tr>
                  <tr>
                  <td colspan="2"><label> Apellidos  </label><br><input type="text" id="apellidosPerfil" name="apellidosPerfil" value="' . $fila['apellidos'] . ' " > <br>
                  <td colspan="1"><input type="text" id="numeroCallePerfil" name="numeroCallePerfil" placeholder="Número de calle" value="' . $fila['numero_calle'] . ' " > <br>
                  <td colspan="1"><label id="margen"> Piso, Puerta, etc. </label><br><input type="text" id="pisoPerfil" name="pisoPerfil" value="' . $fila['piso'] . ' " > <br>
                  </tr>
                  <tr>
                  <td><label> Prefijo </label> <br><select name="prefijoPerfil" id="prefijoPerfil">
                            ...
                            <td><label id="margen"> Número de teléfono </label><br><input type="number" id="telefonoPerfil" name="telefonoPerfil" value="' . $fila['telefono'] . '" > <br>
                            <td><label> Código postal </label><br><input type="text" id="codigoPostalPerfil" name="codigoPostalPerfil" value="' . $fila['codigo_postal'] . ' " > <br>
                            <td><label id="margen"> Provincia </label><br> <select name="provinciaPerfil" id="provinciaPerfil">
                  ...
                  <tr>
                    <td colspan="2">
                      <input type="submit" id="guardar" name="guardar" value="Guardar" style="display: none;">
                      <input type="submit" id="guardar1" name="guardar1" value="Guardar1" style="display: none;">
                      <input type="submit" id="guardar2" name="guardar2" value="Guardar2" style="display: none;">
                      <input type="submit" id="guardar3" name="guardar3" value="Guardar3" style="display: none;">
                    </td>
                  </tr>
                </table>
              </form>';
        ...
        try {
          ...
          echo '<script>
                  Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: "Se ha modificado correctamente el perfil.",
      ...
      if (isset($_POST['guardar2'])) {
        ...
        try {
          ...
          echo "<script>alert(Error al actualizar el perfil: );</script>'" . $e->getMessage();
        }
      }
