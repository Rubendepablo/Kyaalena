                    ...
                    <button class="cerrar"  onclick="location.reload()"><img src="../img/Perfil/store_perfil_de_usuario_cerrar.svg" width="20px" alt="cerrar"></button>
                        ...
                        if (isset($_SESSION['usuario'])) {
                            ...
                            while ($fila = $MyBBDD->extraer_registro()) {
                              ...
                              echo  '<a href="../Codigo/perfil.php">My account</a>
                                    <a href="../Codigo/logout.php">Logout</a>';
                           ...
                           echo '<a href="../Codigo/login.php">Login</a>
                            <a href="../Codigo/registro.php">Register</a>';
                        }
                        ?>
                    </div>
                </div>
