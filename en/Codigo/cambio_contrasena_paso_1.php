...
<body>
	...
	<h2 class="h2">CHANGE OF PASSWORD</h2>
	<div class="DivForm">
		<h3>
		...
		<form method="post" action="#" class="formulario">
			...
			<input class="Inputs" type="email" name="correo" id="correo" placeholder="Enter your email*"><br>
			<button class="continuar" type="submit" name="continuar" id="continuar">Continue</button>
		</form>
	</div>
	...
	if (isset($_POST['continuar'])) {
		...
		if ($MyBBDD->numero_filas() == 1) {
			...
			Swal.fire({
				position: "top-end",
				icon: "success",
				title: "We move on to the last step.",
			...
			Swal.fire({
				icon: "error",
				title: "Oops...",
				text: "The email does not exist, please try again.",
				customClass: {
