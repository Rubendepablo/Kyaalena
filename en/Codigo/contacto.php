...
<body>
    ...
    <div class="frase conversar">I'm here, let's talk</div>
    <div class="frase datos">Leave your contact details and I will get back to you</div>
                ...
                <div class="bloque">
                    <table class="tabla" border="0">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <span class="texto"> First name and surname *</span>
                                <input type="text" class="Inputs" id="nombre-apellido" name="nombre-apellido" placeholder="First name and surname *" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" style="width: 251px;" class="Inputs no-arrows" id="telefono" name="telefono" placeholder="Telephone number *" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <span class="texto"> Reason*</span>
                                <input type="text" class="Inputs" id="motivo" name="motivo" placeholder="Reason *" required>
                            </td>
                        </tr>
                    </table>
                </div>
                <button type="submit" class="btn-enviar" id="enviar" name="enviar">Send</button>
            </form>
        </div>
    </div>
