    ...
    if (isset($_SESSION['usuario'])) {
      ...
      while ($fila = $MyBBDD->extraer_registro()) {
        ...
        echo '<form action="#" method="post">
                <table>
                  <tr> 
                    <td colspan="4"><h1 class="tucuenta">Your account</h1></td>
                  </tr>
                  <tr> 
                  ...
                  <td colspan="2"><label> Password  </label><br><input type="password" id="contrasenaPerfil" name="contrasenaPerfil" value="' . $fila['contrasena'] . ' " disabled><button type="submit" id="btn_edit_contra"><img src="../img/Perfil/store_perfil_de_usuario_editar.svg" width="15px" alt="modificiar"></button><br>
                  </tr>
                  <tr> 
                  <td colspan="2"><h1>Personal Information</h1>
                  <td colspan="2"><h1>Billing address</h1>
                  </tr>           
                  <tr>
                  <td colspan="2"><label> First name  </label><br><input type="text" id="nombrePerfil" name="nombrePerfil" value="' . $fila['nombre'] . ' " > <br>
                  <td colspan="2"><input type="text" id="direccionPerfil" name="direccionPerfil" placeholder="Address" value="' . $fila['direccion'] . ' " > <br>
                  </tr>
                  <tr>
                  <td colspan="2"><label> Last names  </label><br><input type="text" id="apellidosPerfil" name="apellidosPerfil" value="' . $fila['apellidos'] . ' " > <br>
                  <td colspan="1"><input type="text" id="numeroCallePerfil" name="numeroCallePerfil" placeholder="Street number" value="' . $fila['numero_calle'] . ' " > <br>
                  <td colspan="1"><label id="margen"> Floor, Door, etc. </label><br><input type="text" id="pisoPerfil" name="pisoPerfil" value="' . $fila['piso'] . ' " > <br>
                  </tr>
                  <tr>
                  <td><label> Prefix </label> <br><select name="prefijoPerfil" id="prefijoPerfil">
                            ...
                            <td><label id="margen"> Telephone number </label><br><input type="number" id="telefonoPerfil" name="telefonoPerfil" value="' . $fila['telefono'] . '" > <br>
                            <td><label> Postal code </label><br><input type="text" id="codigoPostalPerfil" name="codigoPostalPerfil" value="' . $fila['codigo_postal'] . ' " > <br>
                  ...
                  <tr>
                    <td colspan="2">
                      <input type="submit" id="guardar" name="guardar" value="Save" style="display: none;">
                      <input type="submit" id="guardar1" name="guardar1" value="Save" style="display: none;">
                      <input type="submit" id="guardar2" name="guardar2" value="Save" style="display: none;">
                      <input type="submit" id="guardar3" name="guardar3" value="Save" style="display: none;">
                    </td>
                  </tr>
                </table>
              </form>';
        ...
        try {
          ...
          echo '<script>
                  Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: "Profile has been successfully modified.",
      ...
      if (isset($_POST['guardar2'])) {
        ...
        try {
          ...
          echo "<script>alert(Error updating profile: );</script>'" . $e->getMessage();
        }
      }
