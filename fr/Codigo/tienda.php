    ...
    <div class="container">
        ...
        <?php if ($mensaje != "") { ?>
            <div class="alert alert-success">
                ...
                // print_r($_POST);
                ?>
                <a href="./mostrarCarrito.php" class="badge badge-success ">Voir le panier</a>
            </div>
        <?php } ?>
        <?php if (!isset($_SESSION['usuario'])) { ?>
            <div class="alert alert-success">
                <?php
                echo 'Se connecter pour acheter';
                // print_r($_POST);
                ?>
            </div>
        <?php } ?>
        <h1 id="sueters">Pulls</h1>
        <div class="row">
            <?php
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <label class="talla"><b>Choisissez votre taille:</b></label>
                                ...
                                ?>
                                    <button class="agregar" name="btnAccion" value="Ajouter" type="submit">
                                    Ajouter au panier
                                    </button>
                                <?php
                                }
            ...
            if (!$noProductos) {
                echo '<p class="proximamente">Prochainement...</p>';
            } ?>
        </div>
        ...
        <h1 id="stickers">Autocollants</h1>
        <div class="row">
            <div class="col-5">
                <div class="card">
                    <img title="kyaalena Avatar" class="card-img-top" src="../img/tienda/stickers/1666615542.webp" data-toggle="popover" data-trigger="hover" data-content="utocollants personnalisés avec
avec des images d'avatars dans le style du métavers." width="200px" />
                    <div class="card-body">
                        <div class="flex-row">
            ...
            <div class="col-5">
                <div class="card">
                    <img title="kyaalena Developer" class="card-img-top" src="../img/tienda/stickers/sticker_1.webp" data-toggle="popover" data-trigger="hover" data-content="Autocollants personnalisés avec des photos et des phrases typiques des professionnels du secteur technologique.
technologie." width="200px" />
            ...
            <div class="col-5">
                <div class="card">
                    <img title="kyaalena Interplay" class="card-img-top" src="../img/tienda/stickers/sticker_2.webp" data-toggle="popover" data-trigger="hover" data-content="Autocollants d'interaction avec des icônes et des mots ou phrases de travail à utiliser en groupe" width="200px" />
                    <div class="card-body">
                        <div class="flex-row">
                            <button class="agregar boton-s">
                                <a href="https://t.me/addstickers/kyaalenaInterplay"> <img src="../img/tienda/stickers/store_icono_boton_descarga_sticker_telegram.svg" alt="Telegram" style="width: 30px;" />
