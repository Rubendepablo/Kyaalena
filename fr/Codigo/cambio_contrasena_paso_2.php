...
<body>
    ...
    <h2 class="h2">DERNIÈRE ÉTAPE POUR LE CHANGEMENT DE MOT DE PASSE</h2>
    ...
    <div id="DivForm" class="DivForm">
        ...
        <form action="#" method="post" class="formulario">
            <table>
                <tr>
                    <td class="ojos"><input type="password" class="Inputs" name="nuevacontrasena" id="nuevacontrasena" placeholder="Nouveau mot de passe*"></td>
                    <td>
                ...
                <tr>
                    <td><input type="password" class="Inputs" name="nuevacontrasena_confirm" id="nuevacontrasena_confirm" placeholder="Confirmer le mot de passe*"></td>
                    <td></td>
                </tr>
                <tr>
                    <td><input type="email" class="Inputs" name="correo" id="correo" placeholder="Courriel*"><br>
                        <input class="enviar" type="submit" name="cambio" id="cambio" value="Changer">
                    </td>
    ...
    if (isset($_POST['cambio'])) {
        ...
        if ($nueva == $confirmar) {
            ...
            Swal.fire({
                icon: "error",
                title: "Oops...",
                text: "Les mots de passe saisis ne correspondent pas.",
                customClass: {
