...
<body>
	...
	<h2 class="h2">CHANGEMENT DE MOT DE PASSE</h2>
	<div class="DivForm">
		<h3>
			<p>Saisissez votre adresse électronique</p>
		</h3>

		<form method="post" action="#" class="formulario">

			<input class="Inputs" type="email" name="correo" id="correo" placeholder="Saisissez votre adresse électronique*"><br>
			<button class="continuar" type="submit" name="continuar" id="continuar">Continuer</button>
		</form>
	</div>
	...
	if (isset($_POST['continuar'])) {
		...
		if ($MyBBDD->numero_filas() == 1) {
			...
			Swal.fire({
				position: "top-end",
				icon: "success",
				title: "Nous passons à la dernière étape!.",
			...
			Swal.fire({
				icon: "error",
				title: "Oops...",
				text: "Lemail nexiste pas, veuillez réessayer.",
				customClass: {
