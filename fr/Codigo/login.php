	...
	<div>
		...
		<div class="contInicoSesion">
			<div>
				<form action="#" method="POST">
					<div class="login">
						...
						<input type="email" class="Inputs" id="email" name="email" placeholder="Adresse électronique*" required>

						<br>

						<input type="password" class="Inputs" id="password" name="password" placeholder="Mot de passe*" required>
					</div>
					<a class="button1" href="cambio_contrasena_paso_1.php">Vous avez oublié votre mot de passe ?</a>
					<br>
					<button class="button" type="submit" id="iniciar" name="iniciar">Se connecter</button>
			...
			<div class="crearCuenta">
				...
				<h3><b>Vous n'avez pas de compte ?<br>

				Registre</b></h3><br>

				<button type="submit" id="registrarse" class="button">
					<a class="enlaceRegistro" href="registro.php">S'inscrire</a></button>
			...
			if (!$_POST['email'] == "" && !$_POST['password'] == "") {
				...
				if ($MyBBDD->numero_filas() == 1) {
					...
					Swal.fire({
						icon: "error",
						title: "Oops...",
						text: "Nom dutilisateur ou mot de passe incorrect, veuillez réessayer.",
						customClass: {
				...
				Swal.fire({
					icon: "error",
					title: "Oops...",
					text: "Entrez un nom dutilisateur et un mot de passe.",
					customClass: {
						confirmButton: "my-custom-button-class",
						title: "my-custom-title-class",
						text: "my-custom-text-class"
